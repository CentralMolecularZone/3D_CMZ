PRO gauss_iter_wrapper, origfile, bgfile, prefix, b, cv, iterstr, limitnum, wnan, limit
...
;get rid of zeroes in bg, to prevent mpfitfun from crashing
; added 1/28/13
bg[where(bg le 0)] = !values.f_nan
...
fits_write, prefix+'/sp500_'+prefix+'_gaussfit_iter'+iterstr+'.fits', gaussfit, oghdr
fits_write, prefix+'/sp500_'+prefix+'_gaussfit_median_iter'+iterstr+'.fits', gaussfit_med, oghdr

gfitdiff = ogdata - gaussfit
gfitdiff_med = ogdata - gaussfit_med

fits_write, prefix+'/gfitdiff_'+prefix+'_iter'+iterstr+'.fits', gfitdiff, oghdr
fits_write, prefix+'/gfitdiff_med_'+prefix+'_iter'+iterstr+'.fits', gfitdiff_med, oghdr
...
invertlabel[ws] = 0
invertlabel[wn] = 1
fits_write, prefix+'/gfit_label_iter'+iterstr+'_'+prefix+'.fits', label, oghdr
...
fits_write, prefix+'/bgimage'+iterstr+'_conv720_'+prefix+'_gaussfit.fits', $
  bgimage_conv, oghdr
