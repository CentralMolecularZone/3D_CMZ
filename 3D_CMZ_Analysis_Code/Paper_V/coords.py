...
def xyz2XYZ(x,y,z,vx,vy,vz,xsun=-8.2,ysun=0.0,zsun=0.0,vxsun=0.0,vysun=2.2,vzsun=0.0):
...
def xyz2lbr(x,y,z,vx,vy,vz,xsun=-8.2,ysun=0.0,zsun=0.0,vxsun=0.0,vysun=2.2,vzsun=0.0):
  X,Y,Z,vX,vY,vZ = xyz2XYZ(x,y,z,vx,vy,vz,xsun,ysun,zsun,vxsun,vysun,vzsun)
  l,b,r,vl,vb,vr = XYZ2lbr(X,Y,Z,vX,vY,vZ)
  return l,b,r,vl,vb,vr

def lbr2xyz(l,b,r,vl,vb,vr,xsun=-8.2,ysun=0.0,zsun=0.0,vxsun=0.0,vysun=2.2,vzsun=0.0):
