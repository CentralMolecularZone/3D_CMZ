...
PPDF_gaussian_justification.ipynb was used to create appendix Fig A.
...
make_PPDFs.ipynb produces the prior and posterior PPDFs seen in Fig Fig 3 and A.1. It utilizes values from PPDF_method_info.tex, starcounts_tab.tex, nogueras_measures.tex, and xray_methods.tex to create priors. The values of the posterior distributions are reported in Table 2 (synth_table.tex).
